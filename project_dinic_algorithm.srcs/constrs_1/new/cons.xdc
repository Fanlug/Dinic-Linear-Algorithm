...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { SW_CALCULATE }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
##7 segment display
...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { BTN_CPU_RESET}];
